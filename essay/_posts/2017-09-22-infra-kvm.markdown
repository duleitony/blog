...
http://blog.csdn.net/github_38358734/article/details/70212412
...
登录虚机后，发现网络不通。[参考此文](http://blog.csdn.net/dancheren/article/details/73611878)
将 ifcfg-eth0 的ONBOOT=no修改为yes，
```ruby
systemctl restart NetworkManager  了
```

重启，网络就可以用

修改时间;
http://www.cnblogs.com/rwxwsblog/p/5799764.html
