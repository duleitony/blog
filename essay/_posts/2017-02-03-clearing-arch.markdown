...
也就是，一个总订单会被拆分为多个子订单。这部分内容将在后续的订单系统设计一文中详细介绍。 而订单中和资金相关的内容，都需要在账户体系中建立对应的科目和账户。而在请求支付时，只会将总订单提交支付，拆分子订单是在订单系统中完成的。  
...
[![支付记录](http://blog.lixf.cn/img/in-post/clearing-record.jpg)](http://blog.lixf.cn/img/in-post/clearing-record.jpg)
